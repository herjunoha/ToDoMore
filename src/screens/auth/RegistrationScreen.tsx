...
export const RegistrationScreen: React.FC<RegistrationScreenProps> = ({
  ...
  const validateConfirmPin = (value: string): boolean => {
    if (!value) {
      setConfirmPinError('Confirm PIN is required');
      return false;
    }
    if (value !== pin) {
      setConfirmPinError(ERROR_MESSAGES.PIN_MISMATCH);
      return false;
    }
    setConfirmPinError('');
    return true;
  ...
  const handleRegister = async () => {
    ...
    if (!isUsernameValid || !isPinValid || !isConfirmPinValid) {
      return;
    }
        ...
        <View style={styles.formContainer}>
          <View>
            ...
            <Text style={styles.helperText}>
              {VALIDATION_RULES.USERNAME_MIN_LENGTH}-{VALIDATION_RULES.USERNAME_MAX_LENGTH} characters
            </Text>
          </View>
          ...
          <Input
            ...
            onChangeText={(text) => {
              ...
              if (numericValue) validateConfirmPin(numericValue);
            }}
            onBlur={() => validateConfirmPin(confirmPin)}
